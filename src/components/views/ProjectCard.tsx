...
// Reusable link component helper local to this file? 
// The original code had ProjectLink component in the same file. 
// I should include it here or export it. 
// Since ProjectCard is its own file now, I can define ProjectLink here.
